...
# main bert interface
class BertModel:
    def __init__(self, max_tokens=None, batch_size=32, use_cpu=False, allocate=True, verbose=False):
        fname = (Path(os.path.dirname(__file__)) / 'models' / 'electra-small-6-layers-q4_0.gguf').absolute().as_posix()
